package com.vishaljha.mycredible1.UserDetails;
...
import com.vishaljha.mycredible1.PersonalDetailsClasses.PersonalDetails;
import com.vishaljha.mycredible1.PersonalDetailsClasses.PersonalDetailsData;
import com.vishaljha.mycredible1.ProfilePicClasses.Photo;
import com.vishaljha.mycredible1.R;
import com.vishaljha.mycredible1.Remote.APIUtils;
import com.vishaljha.mycredible1.Remote.UserService;
...
import static com.vishaljha.mycredible1.UserDetails.LoginActivity.MY_PREF;
...
//        });
    ...
    public void setProfilePic(String encodedImage)
    {
        ...
        Call<com.vishaljha.mycredible1.ProfilePicClasses.StatusMessage> call = userService.setProfilePic(photo);
        call.enqueue(new Callback<com.vishaljha.mycredible1.ProfilePicClasses.StatusMessage>() {
            @Override
            public void onResponse(Call<com.vishaljha.mycredible1.ProfilePicClasses.StatusMessage> call, Response<com.vishaljha.mycredible1.ProfilePicClasses.StatusMessage> response) {
                showToast("Profile pic set successfully", Toast.LENGTH_SHORT);
            }

            @Override
            public void onFailure(Call<com.vishaljha.mycredible1.ProfilePicClasses.StatusMessage> call, Throwable t) {
                showToast("Update Personal details Failed: " + t.getMessage(), Toast.LENGTH_SHORT);
            }
